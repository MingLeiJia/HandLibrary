   ...
   public static String Download(String urlstr)
   {
    ...
    public Book parseBookInfo(String str)
    {
        ...
        try{
            ...
            JSONObject mm = mess.getJSONObject("images");
            info.setTitle(mess.getString("title"));
            info.setBitmap(DownloadBitmap(mm.getString("large")));
            ...
            info.setCatalog(mess.getString("catalog"));
            info.setBing(mess.getString("binding"));
